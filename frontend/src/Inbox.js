    ...
    return (
      <div>
        ...
        <div className={`layoutStandard ${this.state.createOpen ? 'createOpen' : ''}`}>
          <div className='logo'>健康链智能合约例子-Inbox</div>
          <div>
            <ul className="li-outer">
              <li className='li_menu'><Link className='style-a' to="/">Home</Link></li>
              <li className='li_menu'><Link className='style-a' to="/about">About</Link></li>
              <li className='li_menu'><Link className='current' to="/inbox">Inbox</Link></li>
            </ul>
          </div>
          <div className='main'>
...
Inbox.displayName = 'Inbox' // Tell React Dev Tools the component name
